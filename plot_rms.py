...
datadir = "/Users/hanjie/Desktop/cold_electronics/CRP/CRP4/CRP4a/coldbox_final/results_LN1/"
datadir1 = "/Users/hanjie/Desktop/cold_electronics/CRP/CRP4/CRP4a/coldbox_final/results_LN2/"
plotdir = "/Users/hanjie/Desktop/cold_electronics/CRP/CRP4/CRP4a/coldbox_final/LN_plots/"
...
def PlotCRP(rms,rms1,snc,st0,st1):
    ...
    plt.scatter(xx_u,uplane,marker='o',label='u plane t1',alpha=0.5)
    plt.scatter(xx_v,vplane,marker='o',label='v plane t1',alpha=0.5)
    plt.scatter(xx_x,xplane,marker='o',label='x plane t1',alpha=0.5)
    plt.scatter(xx_u,uplane1,marker='o',label='u plane t2',alpha=0.5)
    plt.scatter(xx_v,vplane1,marker='o',label='v plane t2',alpha=0.5)
    plt.scatter(xx_x,xplane1,marker='o',label='x plane t2',alpha=0.5)
    plt.legend()
    plt.title(fname)
