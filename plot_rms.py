...
datadir = "/home/hanjie/Desktop/protoDUNE/cold_electronics/CRP/CRP4b/RT_coldbox/rms_results/"
#datadir1 = "/Users/hanjie/Desktop/cold_electronics/CRP/CRP4/CRP4a/coldbox_final/results_LN2/"
plotdir = "/home/hanjie/Desktop/protoDUNE/cold_electronics/CRP/CRP4b/RT_coldbox/rms_plots/"
...
#               xplane1[strip-1]=rms1[global_ch]
    ...
    plt.scatter(xx_u,uplane,marker='o',label='u plane',alpha=0.5)
    plt.scatter(xx_v,vplane,marker='o',label='v plane',alpha=0.5)
    plt.scatter(xx_x,xplane,marker='o',label='x plane',alpha=0.5)
